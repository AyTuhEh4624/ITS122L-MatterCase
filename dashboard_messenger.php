...
<body class="bg-gray-900 text-white">
    <div class="min-h-screen flex flex-col">
        ...
        <div class="bg-gray-700 text-gray-300 px-6 py-3 flex justify-between items-center">
            <span class="text-lg">Messenger <span class="text-green-400">Dashboard</span></span>
        ...
        <div class="flex-grow flex items-center justify-center">
            <div class="bg-gradient-to-b from-gray-700 to-gray-900 text-center rounded-lg p-8 shadow-lg w-[80%] max-w-2xl">
                <h1 class="text-3xl font-semibold">Welcome to Messenger!</h1>
                <p class="text-lg text-gray-300 mt-2">Manage and communicate efficiently</p>
