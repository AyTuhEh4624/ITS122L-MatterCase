...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: view_case_evidence.php?case_id={$evidence['case_id']}&success=1");
        exit();
    } else {
        // Redirect back to the edit evidence page with an error message
        header("Location: edit_evidence_page.php?evidence_id=$evidence_id&error=1");
...
<body>
    ...
    <p><a href="view_case_evidence.php?case_id=<?php echo $evidence['case_id']; ?>">Back to Case Details</a></p>
</body>
</html>